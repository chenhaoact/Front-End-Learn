...
var Comment = React.createClass({  //1.React.createClass() 创建一个react元素
    ...
    render: function () {
        /**
         * 6. props
         * 从父级传来的数据在子组件里作为 '属性' 可供使用。
         * 这些 '属性' 可以通过 this.props 访问
         * 比如下面的 this.props.author就是 Comment组件在调用时以
...
var CommentForm = React.createClass({
    /**
     * 7. state
     * 为了实现交互，给组件引进了可变的state。this.state是组件私有的，
     * 可以通过调用this.setState()改变它。每当state更新，组件就重新渲染自己。
    ...
    render: function () {
        ...
        return (
            <form className="commentForm" onSubmit={this.handleSubmit}>
                ...
                />
                {/**
                 * React使用小驼峰命名规范(camelCase)给组件绑定事件处理器。如上面的onChange={this.handleAuthorChange}
                 * */}
                <input
                    type="text"
